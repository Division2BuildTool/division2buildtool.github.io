...
- [GitHub Releases](https://github.com/division2buildtool/division2buildtool.github.io/releases)
    ...
    如果直接下载较慢，可以复制文件链接使用[GitHub 文件加速1](https://gh.llkk.cc/)或[GitHub 文件加速2](https://github.akams.cn/)等进行下载

- [蓝奏云](https://wwbb.lanzout.com/b03vesg4h)     密码：3z9a

    移动端下载apk/ipa文件时会提示需要会员才能分享（是蓝奏云官方限制该类文件），将手机浏览器的界面切换为桌面模式，即可跳过限制下载文件。
